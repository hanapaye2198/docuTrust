export const FIELD_TYPES = {
    signature: { label: 'Signature', canvasLabel: 'Signature', kind: 'signature', signatureAlignment: 'center', fill: 'rgba(59, 130, 246, 0.10)', stroke: '#2563eb', text: '#1d4ed8', width: 0.26, height: 0.058, minWidth: 0.18, minHeight: 0.04, accent: '#2563eb' },
    signature_left: { label: 'Signature (Left aligned)', canvasLabel: 'Signature', kind: 'signature', signatureAlignment: 'left', fill: 'rgba(20, 184, 166, 0.10)', stroke: '#0f766e', text: '#115e59', width: 0.26, height: 0.058, minWidth: 0.18, minHeight: 0.04, accent: '#0f766e' },
    signature_right: { label: 'Signature (Right aligned)', canvasLabel: 'Signature', kind: 'signature', signatureAlignment: 'right', fill: 'rgba(14, 165, 233, 0.10)', stroke: '#0369a1', text: '#075985', width: 0.26, height: 0.058, minWidth: 0.18, minHeight: 0.04, accent: '#0369a1' },

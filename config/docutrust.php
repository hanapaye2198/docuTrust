...
return [
    ...
    */
    ...
    'notary' => [
        ...
        'max_documents_per_request' => (int) env('DOCUTRUST_NOTARY_MAX_DOCUMENTS_PER_REQUEST', 1),
        'auto_invite_signers_to_video' => (bool) env('DOCUTRUST_NOTARY_AUTO_INVITE_SIGNERS_TO_VIDEO', true),
        'signer_video_default_hours_ahead' => (int) env('DOCUTRUST_NOTARY_SIGNER_VIDEO_HOURS_AHEAD', 24),

...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | DocuTrust Secure Disk
    |--------------------------------------------------------------------------
    |
    | This disk is used for sensitive document/signature assets. Keep it on a
    | private filesystem (local private path or a private cloud bucket).
    |
    */
    'docutrust_disk' => env('DOCUTRUST_FILESYSTEM_DISK', 'local'),
